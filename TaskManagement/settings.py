...
SECRET_KEY = '8&2rd4u8w+5+^&+scu@8086!1(!z^oiezimfe(g^9-=ho1npc_'
#SECRET_KEY = os.environ['SECURITY_KEY']

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
ALLOWED_HOSTS = ['*']
#ALLOWED_HOSTS = ["to-do-journal.herokuapp.com" , "localhost"]
...
EMAIL_HOST_USER='farazhussain651@gmail.com'
EMAIL_HOST_PASSWORD='prbmyvyphyazfoca'
